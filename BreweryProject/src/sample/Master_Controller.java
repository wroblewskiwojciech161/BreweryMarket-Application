...
public class Master_Controller implements Initializable {
    ...
    @FXML
    public  TextField txtSetLoginUserId;
    @FXML
    public  TextField txtSetLoginNewLogin;
    @FXML
    ...
    @FXML
    public  void updateLogin(MouseEvent mouseEvent) throws SQLException, ClassNotFoundException {
        try{
            BreweryDAO.updateLogin(Integer.valueOf(txtSetLoginUserId.getText()),txtSetLoginNewLogin.getText());
            labelInfo.setText("properly updated user login . New one : "+txtSetLoginNewLogin.getText());
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        colCustomerId.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Mark, Integer>, ObjectProperty<Integer>>() {
            public ObjectProperty<Integer> call(TableColumn.CellDataFeatures<Mark, Integer> p) {
                // p.getValue() returns the Person instance for a particular TableView row
